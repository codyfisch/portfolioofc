...
class Comments
{
    ...
    public function showComments($blog_id)
    {
        ...
        foreach($this->comments as $c)
        {
            ...
            {
//                todo - use a similar format to this for the entries!!
...
//                    todo - /portfolioofc
                    ...
                    $admin = "<a href=\"/portfolioofc/inc/update.inc.php
...
//                    todo - /portfolioofc
        ...
        return <<<FORM
<form action="/portfolioofc/inc/update.inc.php"
...
<link rel="stylesheet" type="text/css"
    href="/portfolioofc/css/default.css" />
</head>
<body>
